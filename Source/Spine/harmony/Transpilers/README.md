...
# Better Work Tab port

This copy was synchronized from `Sheltered/shelteredmodmanager` commit
`b7861aefef0a8cd5d45a47f3dc606dbefd5a991b` and adapted from
`ModAPI.Harmony` to `Spine.Harmony`. The BWT project compiles the core fluent
transpiler suite and keeps optional Harmony modules as `None` project items.
