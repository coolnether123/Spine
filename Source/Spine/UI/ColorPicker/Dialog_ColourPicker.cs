...
namespace Spine.UI.ColourPicker {
    public class Dialog_ColourPicker : Window {
        ...
        /// <summary>
        ///     Call with the current colour, and a callback which will be passed the new colour when 'OK' or 'Apply' is pressed. The bool in the callback is true when 'OK' is pressed.
        ...
        protected override void SetInitialSizeAndPosition()
        {
            ...
            Vector2 position = new Vector2(
                Mathf.Max(0f, Mathf.Min(InitialPosition.x, Verse.UI.screenWidth - size.x)),
